...
* `markdownCompat`: flag setting equivalent to maximize Markdown compatibility,
  currently `markdownHorizontalRules`, `markdownLinks`, and `markdownLists`
...
* `styles`: styles for [emphasis](#emphasis), [horizontal rules](#horizontal-rules),
  or [label/ref](#label-ref);
