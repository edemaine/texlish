...
* CLI `--pdf` and related LaTeX engine options now write compiled output
  in the same directory as the input `.texlish` file and generated `.tex` file;
  and support Cygwin LaTeX.
